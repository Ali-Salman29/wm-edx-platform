...
class Command(BaseCommand):
    ...
    def msgmergenew(self, locales, translation_files, base_lang='en', generate_po_file_if_not_exist=False, output_file_mapping={}):
        """
    ...
    def handle(self, *args, **options):
        ...
        if options['action'] == 'pull_transifex_translations':
            ...
            self.msgmergenew(locales, targated_files)
