...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "Allow others to copy, distribute, display and perform only verbatim copies of your work, not derivative works based upon it. This option is incompatible with \"Share Alike\".": "Permitir que otros copien, distribuyan, muestren y representen solamente copias literales de tu trabajo, pero no trabajos derivados basados en este. Esta opci\u00f3n es incompatible con \u201cCompartir lo mismo\u201d",
    "Allow others to copy, distribute, display and perform your copyrighted work but only if they give credit the way you request. Currently, this option is required.": "Permitir que otros copien, distribuyan, muestren y representen tu trabajo con derechos de autor, siempre y cuando se reconozca el cr\u00e9dito correspondiente de la forma que t\u00fa especifiques. Actualmente, esta opci\u00f3n es necesaria.",
    ...
    "Chapter name and asset_path are both required": "El nombre del cap\u00edtulo y la ruta_del_recurso son obligatorios",
    ...
    "Deleting a textbook cannot be undone and once deleted any reference to it in your courseware's navigation will also be removed.": "La eliminaci\u00f3n de un libro de texto no puede deshacerse y, una vez eliminado, cualquier referencia a \u00e9l en la navegaci\u00f3n de su curso tambi\u00e9n se eliminar\u00e1.",
    ...
    "Explicitly Hiding from Students": "Ocultar solo para los estudiantes",
    ...
    "File format not supported. Please upload a file with a {ext} extension.": "Formato de archivo no admitido. Debes cargar un archivo con una extensi\u00f3n {ext}",
    ...
    "Inheriting Student Visibility": "Heredando la visibilidad de los estudiantes",
    ...
    "Making Visible to Students": "Haciendo visible para los estudiantes",
    "Manage": "Administrar",
    ...
    "Select income": "Seleccionar ingresos",
    ...
    "Share": "Compartir",
    "Share Alike": "Compartir lo mismo",
    ...
    "Thank you! You\u2019re helping make edX better for everyone.": "\u00a1Gracias! Est\u00e1s ayudando a que edX sea mejor para todos.",
    ...
    "There was an error when trying to add learners:": [
      "Hubo un error al intentar agregar alumnos:",
      "No se pudieron agregar {numErrors} alumnos a esta cohorte:",
      "No se pudieron agregar {numErrors} alumnos a esta cohorte:"
    ],
    ...
    "Welcome to edX! Before you get started, please take a few minutes to fill-in the additional information below to help us understand a bit more about your background. You can always edit this information later in Account Settings.": "\u00a1Bienvenido a edX! Antes de comenzar, t\u00f3mese unos minutos para completar la informaci\u00f3n adicional a continuaci\u00f3n para ayudarnos a comprender un poco m\u00e1s sobre sus antecedentes. Siempre puede editar esta informaci\u00f3n m\u00e1s adelante en Configuraci\u00f3n de la cuenta.",
    ...
    "Which of the following describes you best?": "\u00bfCu\u00e1l de los siguientes te describe mejor?",
    ...
    "Yes, delete this {xblock_type}": "S\u00ed, eliminar este {xblock_type}",
    ...
    "{numMoved} learner was moved from {prevCohort}": [
      ...
      "{numMoved} los alumnos fueron movidos de {prevCohort}",
      "{numMoved} los alumnos fueron movidos de {prevCohort}"
    ],
    "{numPreassigned} learner was pre-assigned for this cohort. This learner will automatically be added to the cohort when they enroll in the course.": [
      "{numPreassigned} alumno fue preasignado para esta cohorte. Este alumno se agregar\u00e1 autom\u00e1ticamente a la cohorte cuando se inscriba en el curso.",
      "Se asignaron previamente {numPreassigned} alumnos para esta cohorte. Estos alumnos se agregar\u00e1n autom\u00e1ticamente a la cohorte cuando se inscriban en el curso.",
      "Se asignaron previamente {numPreassigned} alumnos para esta cohorte. Estos alumnos se agregar\u00e1n autom\u00e1ticamente a la cohorte cuando se inscriban en el curso."
    ],
    ...
    "{numUsersAdded} learner has been added to this cohort. ": [
      "Se ha agregado {numUsersAdded} alumno a esta cohorte.",
      "Se han agregado {numUsersAdded} estudiantes a esta cohorte.",
      "Se han agregado {numUsersAdded} estudiantes a esta cohorte."
    ],
    "{numVotes} Vote": [
      "{numVotes} Votar",
